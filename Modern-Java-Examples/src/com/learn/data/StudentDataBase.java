...
public class StudentDataBase {
    ...
    public static List<Student> getAllStudents() {
        ...
        Student student1 = new Student("Adam", 2, "male", 4.5, Arrays.asList("swimming", "basketball"), 10);
        Student student2 = new Student("Jenny", 2, "female", 3.6, Arrays.asList("swimming", "soccer"), 12);


        Student student3 = new Student("Emily", 3, "female", 4.5, Arrays.asList("swimming", "basketball", "football"), 10);
        ...
        Student student6 = new Student("James", 4, "male", 6.5, Arrays.asList("swimming", "basketball"), 5);
